...
const copy = {
  vi: {
    metadata: {
      ...
      description: "Bài viết ngắn gọn về cách chọn sách, đọc hiệu quả và mua sắm thông minh hơn.",
    },
    shell: {
    ...
    articles: [
      {
        ...
        excerpt: "Một hướng dẫn ngắn để ghép đầu sách với nhu cầu học, làm việc hoặc phát triển bản thân.",
        meta: "Hướng dẫn",
        tag: "Lộ trình đọc",
      },
      {
        title: "Năm nhóm sách đáng có trong tủ sách cá nhân",
        excerpt: "Danh sách ngắn những nhóm sách hữu ích, phù hợp với thói quen đọc hằng ngày và gia đình.",
        meta: "Gợi ý nhanh",
        tag: "Nổi bật",
      },
      {
        title: "Mua sách nhanh hơn với bộ lọc tốt hơn",
        excerpt: "Dùng danh mục, tác giả và từ khóa để rút ngắn thời gian tìm kiếm và đến đúng sản phẩm nhanh hơn.",
        meta: "Mẹo mua sắm",
        tag: "Tìm kiếm",
      },
    ],
    ...
    ctaBody: "Đi thẳng tới catalog hoặc danh mục để tiếp tục khám phá mà không cần thêm thao tác vòng vo.",
  ...
  en: {
    metadata: {
      ...
      description: "Short reads on choosing books, reading well, and shopping smarter.",
    },
    shell: {
      badgeText: "Reading & picks",
      breadcrumbs: [{ label: "Blog" }],
      description: "A light content space for book picks, shopping tips, and simple reading inspiration.",
      title: "BookStore Blog",
    },
    highlights: [
    ...
    articles: [
      {
        ...
        excerpt: "A short guide for matching book picks with study, work, or self-growth needs.",
        meta: "Guide",
        tag: "Reading path",
      },
      {
        title: "Five book groups worth keeping on your shelf",
        excerpt: "A compact set of useful categories that fit everyday reading habits and family shelves.",
        meta: "Quick picks",
        tag: "Featured",
      },
      {
        title: "Shop faster with better filters",
        excerpt: "Use categories, authors, and keywords to shorten search time and land on the right product sooner.",
        meta: "Shopping tip",
        tag: "Search",
      },
    ],
    ...
    ctaBody: "Jump straight to the catalog or categories and keep going without any extra detours.",
        ...
        <section className="rounded-3xl border border-indigo-100 bg-gradient-to-r from-indigo-50 via-white to-slate-50 p-8 shadow-sm">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="max-w-2xl">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-indigo-600">{page.ctaHeading}</p>
