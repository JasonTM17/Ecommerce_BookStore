          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-lg text-red-50">
                Xem các mã giảm giá đang hoạt động, sao chép mã phù hợp và áp
                dụng ngay ở giỏ hàng hoặc bước thanh toán như luồng mua sắm hiện
                tại.
              </p>
              ...
              <div className="mb-6 flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900">
                    Coupon đang khả dụng
                  </h2>
                  <p className="mt-1 text-gray-500">
                    Sao chép mã bạn cần ngay bây giờ và áp dụng ở bước xem giỏ
                    hàng hoặc hoàn tất thanh toán.
                  </p>
                </div>
              </div>
              ...
              <section className="rounded-3xl bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-3 text-sm text-gray-600">
                  <div className="rounded-2xl bg-gray-50 p-4">
                    ...
                    <p className="mt-1">
                      Dùng nút sao chép nhanh trên bất kỳ coupon card nào.
                    </p>
                  </div>
                  <div className="rounded-2xl bg-gray-50 p-4">
                    <p className="font-medium text-gray-900">
                      2. Xem điều kiện áp dụng
                    </p>
                    <p className="mt-1">
                      Kiểm tra giá trị đơn tối thiểu, hạn sử dụng và lượt dùng
                      còn lại.
                    </p>
                  </div>
                  <div className="rounded-2xl bg-gray-50 p-4">
                    <p className="font-medium text-gray-900">
                      3. Áp dụng tại giỏ hàng hoặc checkout
                    </p>
                    <p className="mt-1">
                      Luồng nhập coupon chính thức vẫn giữ đúng ở nơi người dùng
                      đã quen thao tác.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold">
                      Sẵn sàng dùng mã giảm giá?
                    </h2>
                    <p className="mt-2 text-sm leading-6 text-gray-300">
                      Chọn sách bạn muốn mua rồi đi tới giỏ hàng hoặc bước thanh
                      toán để áp dụng mã trong đúng luồng mua sắm hiện tại.
                    </p>
                  </div>
                </div>
