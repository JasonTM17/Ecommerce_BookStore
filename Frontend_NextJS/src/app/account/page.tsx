          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-2">
                  {user.roles.map((role) => (
                    ...
                    >
                      {role === "ADMIN" ? "Quản trị" : role === "CUSTOMER" ? "Khách hàng" : role}
                    </span>
                  ))}
                </div>
              </div>
              ...
              <nav className="space-y-2">
                <Link href="/account" className="block px-4 py-2 rounded bg-primary/10 text-primary font-medium">
                  Thông tin tài khoản
                </Link>
                <Link href="/orders" className="block px-4 py-2 rounded hover:bg-gray-100 text-gray-700">
                  Đơn hàng của tôi
                </Link>
              </nav>
            </CardContent>
