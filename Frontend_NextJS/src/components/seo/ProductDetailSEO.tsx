    ...
    <>
      ...
      <BookSchema
        book={{
          ...
          isbn: (product as Record<string, unknown>).isbn as string | undefined,
          publisher: (product as Record<string, unknown>).publisher as string | undefined,
          publishYear: (product as Record<string, unknown>).publishedYear as number | undefined,
